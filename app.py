...
from models.skills_data import skills_data

# Initialize components
pdf_extractor = PDFTextExtractor()
skills_extractor = SkillsExtractor(skills_data)
sentiment_analyzer = SentimentAnalyzer()
recommendation_generator = RecommendationGenerator(skills_data)
...
if uploaded_file:
    ...
    recommendations = recommendation_generator.generate_recommendations(selected_category, skills, sentiment)
